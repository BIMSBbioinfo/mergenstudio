...
Any code that might be generated by the LLM is automatically folded. To
unfold the code, press the button on the side:

<img src="man/figures/unfold_code.png" align="middle" height="600" style="float:middle; height:600px;"/>
<img src="man/figures/unfolded_code.png" align="middle" height="600" style="float:middle; height:600px;"/>

To try and run code from a response, simply press the green play button
on the right side of the chat box. This will run the code, and show you
the output.
...
To automatically run any code that is generated by the LLM, turn on the
option `Activate auto execution` from the `Chat options` panel.
