...
#'   retrieved from the "mergenstudio.code_style" option. Default is the
#'   "mergenstudio.code_style" option. Options are "base", "tidyverse", or
#'   "no preference".
#' @param skill The skill level of the user for the chat conversation. This
#'   can be set through the "mergenstudio.skill" option. Default is the
