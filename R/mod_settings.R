      ...
      bslib::accordion_panel(
        ...
        radioButtons(
          ...
          label = getIconLabel("Activate file header addition",
                               message="Activating file header addition will attempt to add the first few lines of files mentioned in your prompt to your prompt. The directory that will be searched can be set with 'Select directory'"
                               ),
          choiceNames = c("Yes","No"),
          choiceValues = c(TRUE, FALSE),
          selected = FALSE,
